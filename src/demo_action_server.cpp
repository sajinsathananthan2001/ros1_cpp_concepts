...
protected:
  ...
  actionlib::SimpleActionServer<ros1_cpp_concepts::Demo_actionAction> as; 
  // create messages that are used to published feedback/result
  ros1_cpp_concepts::Demo_actionFeedback feedback;
  ros1_cpp_concepts::Demo_actionResult result;
